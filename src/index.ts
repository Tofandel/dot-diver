...
type SafeObject = Record<string | number, unknown>
type SearchableObject = Record<never, never> | unknown[] & SafeObject
...
const throwAssignmentError = (current: unknown, path: string) => {
